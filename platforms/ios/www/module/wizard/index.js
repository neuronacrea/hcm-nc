...
.controller('wizardController', ['$scope', '$ionicSlideBoxDelegate', 'ngWizardPath', function($scope, $ionicSlideBoxDelegate, path) {
  var _this = this;
  ...
  _this.addImageOnComponent = function(data) {
      if (data && data.backgroundImage) {
          angular.element('.container-image').css({'background-image': 'url("'+ data.backgroundImage + '")'});
      }
  };
